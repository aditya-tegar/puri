          ...
          <div class="col-md-12">
            ...
            <div class="card card-primary">
              <div class="card-header">
                <h3 class="card-title">Form Edit Data Sampah</h3>
              </div>
              <!-- /.card-header -->
              <!-- form start -->
              <form action="{{route('sampah.update', $sampah->id)}}" method="post">
                ...
                <div class="card-body">
                  <div class="form-group">
                    ...
                    <input class="form-control" id="nama_sampah" name="nama_sampah" value="{{$sampah->nama_sampah}}" require>
                  </div>
                  <div class="form-group">
                    <label for="harbel">Harga Beli</label>
                    <input type="number" class="form-control" id="harbel" name="harga_beli" value="{{$sampah->harga_beli}}" require>
                  </div>
                  <div class="form-group">
                    <label for="harju">Harga Jual</label>
                    <input type="number" class="form-control" id="harju" name="harga_jual" value="{{$sampah->harga_jual}}" require>
                  </div>
                </div>
                </div>
                <!-- /.card-body -->
