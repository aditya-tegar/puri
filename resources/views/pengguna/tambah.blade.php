          ...
          <div class="col-md-12">
            ...
            <div class="card card-primary">
              <div class="card-header">
                <h3 class="card-title">Form Penambahan Data Pengguna</h3>
              </div>
              <!-- /.card-header -->
              <!-- form start -->
              <form>
                <div class="card-body">
                  ...
                  <div class="form-group">
                    ...
                    <input class="form-control" id="nama_pengguna" placeholder="Input Nama Pengguna" require>
                  </div>
                  <div class="form-group">
                    <label for="user">Username</label>
                    <input type="email" class="form-control" id="user" placeholder="Input Username" require>
                  </div>
                  <div class="form-group">
                    <label for="pass">Password</label>
                    <input type="password" class="form-control" id="pass" placeholder="Input Password" require>
                  </div>
                  <!-- select -->
                  <div class="form-group">                  
                    <div class="form-group">
